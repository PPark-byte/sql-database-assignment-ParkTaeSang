...
select s.sale_id, s.sale_date, p.product_name, c.customer_name, c.customer_type, c.customer_region,
s.sales_type, s.quantity, s.sale_amount, s.payment_status
...
and s.sale_amount > (
	...
	from public.sales as sub
	where sub.sale_date between '2025-04-01' and '2025-06-30'
	and sub.sales_type != '반품')
